-- FindHiddenJobs.com Database Schema for Supabase
-- Run these SQL commands in your Supabase SQL Editor

-- Enable required extensions
create extension if not exists "uuid-ossp";

-- Jobs table (scraped job data)
...
-- User preferences (linked to Supabase auth.users)
...
-- Jobs and searches tables are public (no RLS needed for job listings)
-- But you might want to add RLS later for user-specific job data
